...
public class PayrollProcessing extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButtonPrintPayslip, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 250, 140, 23));

        jButtonAddPayroll.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jButtonAddPayroll.setText("SAVE");
        jButtonAddPayroll.setBorder(javax.swing.BorderFactory.createEtchedBorder(java.awt.Color.white, java.awt.Color.white));
        jButtonAddPayroll.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonAddPayrollActionPerformed(evt);
            }
        });
        getContentPane().add(jButtonAddPayroll, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 210, 140, 23));

        jLabel24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/photos/PayrollD.jpg"))); // NOI18N
        getContentPane().add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 860, 430));
