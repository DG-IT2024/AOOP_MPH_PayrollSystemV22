...
public class TimesheetDialogAdd extends JDialog {
    ...
    public TimesheetDialogAdd(int empId) {
    ...
    private void initComponents() {
        ...
        btnOk.addActionListener(e -> {
            ...
            try {
                ...
                Logger.getLogger(TimesheetDialogAdd.class.getName()).log(Level.SEVERE, null, ex);
