...
public class TimesheetDialogUpdate extends JDialog {
    ...
    public TimesheetDialogUpdate(Frame parent, int attendanceId, int approverId) {
    ...
    private void initComponents() {
        ...
        btnOk.addActionListener(e -> {
            ...
            try {
                ...
                Logger.getLogger(TimesheetDialogUpdate.class.getName()).log(Level.SEVERE, null, ex);
...
//        System.out.println("Overtime Approver ID: " + getOvertimeApproverId());
    ...
    public void main(String[] args) {
        TimesheetDialogUpdate dialog = new TimesheetDialogUpdate(null, attendanceId, approverId);
