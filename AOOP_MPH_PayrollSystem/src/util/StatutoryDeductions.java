...
//    // Total deductions: benefits + withholding tax
//    public static double calculateTotalDeductions(double monthlySalary) {
//        return calculateTotalBenefitsDeductions(monthlySalary) + calculateWithholdingTax(monthlySalary);
//    }
//
//    // Calculate net pay after all deductions
//    public static double calculateNetPay(double monthlySalary) {
//        return monthlySalary - calculateTotalDeductions(monthlySalary);
//    }
}
