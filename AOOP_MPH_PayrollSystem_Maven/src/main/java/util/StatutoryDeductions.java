...
public class StatutoryDeductions {
    ...
    public static double taxableIncome(double basis) {
        Double taxableIncome = basis - calculateSSS(basis) - calculatePagIbig(basis) - calculatePhilHealth(basis);
    ...
    public static double totalDeduction(double basis, double taxableMonthlyPay) {
        double totalDeductions = calculateSSS(basis) +  calculatePagIbig(basis) +calculatePhilHealth(basis)+ calculateWHTax(taxableMonthlyPay);
