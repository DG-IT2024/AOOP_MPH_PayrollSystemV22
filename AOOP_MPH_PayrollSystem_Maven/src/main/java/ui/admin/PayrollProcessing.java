...
public class PayrollProcessing extends javax.swing.JFrame {
    ...
    private void displayPayDetails() {
        try {
            ...
            // Deductions
            jTextSssDeduction.setText(String.format("%.2f", StatutoryDeductions.calculateSSS(grossIncome)));
            jTextFieldPhilHealthDeduction.setText(String.format("%.2f", StatutoryDeductions.calculatePhilHealth(grossIncome)));
            jTextFieldPagibigDeduction.setText(String.format("%.2f", StatutoryDeductions.calculatePagIbig(grossIncome)));

            double taxableIncome = StatutoryDeductions.taxableIncome(grossIncome);
            jTextFieldWHT.setText(String.format("%.2f", StatutoryDeductions.calculateWHTax(taxableIncome)));

            double deductionsTotal = StatutoryDeductions.totalDeduction(grossIncome, taxableIncome);
    ...
    private void initComponents() {
        ...
        jButtonCompute2 = new javax.swing.JButton();
        ...
        jPanel1.add(jButtonCompute1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 310, 110, 30));

        jButtonCompute2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jButtonCompute2.setText("Clear");
        jButtonCompute2.setBorder(javax.swing.BorderFactory.createEtchedBorder(java.awt.Color.white, java.awt.Color.white));
        jButtonCompute2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonCompute2ActionPerformed(evt);
            }
        });
        jPanel1.add(jButtonCompute2, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 310, 110, 30));
    ...
    private void jButtonCompute2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCompute2ActionPerformed
        clearFields();
    }//GEN-LAST:event_jButtonCompute2ActionPerformed
    ...
    private javax.swing.JButton jButtonCompute2;
