...
public class trial1 {
    ...
    public static void timeEntry(int employeeNumber_, int coveredDays, int maxRegularHours) {
        ...
        while (true) {
            ...
            ConditionalPrintToFileOrConsole(employeeNumber_, maxRegularHours, workedDays, coveredDays, regularHoursList, overtimeHoursList);
    ...
    public static void ConditionalPrintToFileOrConsole(int employeeNumber_, int maxRegularHours, int workedDays, int coveredDays, ArrayList<Integer> regularHoursList, ArrayList<Integer> overtimeHoursList) {
        Scanner printPrompt = new Scanner(System.in);
        ...
        while (true) {
            ...
            String saveResponse = printPrompt.nextLine();
