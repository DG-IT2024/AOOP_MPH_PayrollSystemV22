...
public class TimeSheet_1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Time In ", "Tme Out", "Worked Hours"
            }
        ));
    ...
    private void btn_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_addActionPerformed
       ...
       // Split the input string by ":"
        ...
        int workedHour = hour2-hour1;
        String workedHour_=Integer.toString(workedHour);
        ...
        if(txt_date.getText().equals("")||txt_TimeIN.getText().equals("")||txt_TimeOUT.getText().equals("")){
            ...
            String timeSheetData[]={txt_date.getText(),txt_TimeIN.getText(),txt_TimeOUT.getText(),workedHour_};
