/*
Notes:
Time in 12:00 to 13:00. breaktime. Not counted as working hour
...
public class motorPHdraft2 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // Error handling for employee number input
            while (true) {
                if (entry.hasNextInt()) {
                    employeeNumber = entry.nextInt();
                    if (isValidEmployeeNumber(employeeNumber, validEmployeeNumbers)) {
                        break; // Valid employee number, exit loop
                    } else {
                    ...
                    entry.next(); // Clear invalid input
                }
            }

            int employeeNumber_ = Integer.parseInt("11");
    ...
    public static boolean isValidEmployeeNumber(int employeeNumber, int[] validEmployeeNumbers) {
        for (int validNumber : validEmployeeNumbers) {
            if (employeeNumber == validNumber) {
                return true; // Employee number is valid
            }
        }
        return false;
